...
// node_modules/mafs/build/index.js
...
// node_modules/mafs/node_modules/use-resize-observer/dist/bundle.esm.js
...
function computeAnchor(anchor, x, y, width, height) {
  let actualX = x;
  let actualY = y;
  switch (anchor) {
    case "tl":
...
function ViewportInfo({ precision = 3 }) {
  ...
  return (0, import_jsx_runtime2.jsxs)("g", { className: "mafs-shadow", fontFamily: "monospace", children: [
    (0, import_jsx_runtime2.jsxs)("text", { x: x + 10, y: y - 70, children: [
      "x: (",
    ...
    (0, import_jsx_runtime2.jsxs)("text", { x: x + 10, y: y - 50, children: [
      "y: (",
    ...
    (0, import_jsx_runtime2.jsxs)("text", { x: x + 10, y: y - 30, children: [
      "xPanes: ",
      xPanesString
    ] }),
    (0, import_jsx_runtime2.jsxs)("text", { x: x + 10, y: y - 10, children: [
      "yPanes: ",
      yPanesString
    ] })
  ] });
...
function useMovable(args) {
  ...
  const inverseTransform = React8.useMemo(() => getInverseTransform(userTransform), [userTransform]);
  const pickup = React8.useRef([0, 0]);
  useDrag(
    (state) => {
...
var MovablePointDisplay = React9.forwardRef(
  (props, ref) => {
    const { color = Theme.pink, ringRadiusPx = 15, dragging, point } = props;
    const { viewTransform, userTransform } = useTransformContext();
    const combinedTransform = React9.useMemo(
    ...
    return (0, import_jsx_runtime3.jsxs)(
      "g",
      {
        ...
        tabIndex: 0,
        children: [
          (0, import_jsx_runtime3.jsx)("circle", { className: "mafs-movable-point-hitbox", r: 30, cx: xPx, cy: yPx }),
          ...
          (0, import_jsx_runtime3.jsx)("circle", { className: "mafs-movable-point-ring", r: ringRadiusPx, cx: xPx, cy: yPx }),
          (0, import_jsx_runtime3.jsx)("circle", { className: "mafs-movable-point-point", r: 6, cx: xPx, cy: yPx })
        ]
      }
    );
  }
...
function MovablePoint({
  ...
  return (0, import_jsx_runtime4.jsx)(MovablePointDisplay, { ref, point, color, dragging });
}
...
function useMovablePoint(initialPoint, { constrain, color = Theme.pink } = {}) {
  ...
  const [point, setPoint] = React11.useState(initialPoint);
  const [x, y] = point;
  const constraintFunction = React11.useMemo(() => {
  ...
  const element = React11.useMemo(() => {
    return (0, import_jsx_runtime5.jsx)(MovablePoint, { ...{ point, color }, constrain: constraintFunction, onMove: setPoint });
...
function Transform(props) {
  ...
  return (0, import_jsx_runtime6.jsx)(TransformContext.Provider, { value: { userTransform: newUserTransform, viewTransform }, children: (0, import_jsx_runtime6.jsx)("g", { style: { "--mafs-user-transform": vec.toCSS(newUserTransform) }, children }) });
}
...
function Ellipse({
  ...
  return (0, import_jsx_runtime7.jsx)(
    "ellipse",
    {
      ...
      style: {
        stroke: color,
        strokeDasharray: strokeStyle === "dashed" ? "var(--mafs-line-stroke-dash-style)" : void 0,
        fill: color,
        fillOpacity,
        strokeOpacity,
...
function Circle({ radius, ...rest }) {
  return (0, import_jsx_runtime8.jsx)(Ellipse, { radius: [radius, radius], ...rest });
}
...
function Polygon({ svgPolygonProps, ...otherProps }) {
  return (0, import_jsx_runtime10.jsx)(PolyBase, { element: "polygon", svgPolyProps: svgPolygonProps, ...otherProps });
}
...
function TransformWidget({ children }) {
  ...
  return (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
    (0, import_jsx_runtime11.jsxs)(Transform, { translate: t.point, children: [
      (0, import_jsx_runtime11.jsxs)(Transform, { rotate: angle, children: [
        (0, import_jsx_runtime11.jsxs)(Transform, { scale: s.point, children: [
          children,
...
function Mafs({
  ...
  const testContext = React12.useContext(TestContext);
  ...
  return (0, import_jsx_runtime12.jsx)(
    "div",
    {
      ...
      ref: rootRef,
      children: width > 0 && (0, import_jsx_runtime12.jsx)(
        MafsCanvas,
        {
          width,
          height,
...
function MafsCanvas({
  ...
  const viewTransform = React12.useMemo(() => {
  ...
  const inverseViewTransform = vec.matrixInvert(viewTransform);
  const pickupOrigin = React12.useRef([0, 0]);
  const pickupPoint = React12.useRef([0, 0]);
  ...
  const justDragged = React12.useRef(false);
  useGesture(
    {
  ...
  const coordinateContext = React12.useMemo(
    () => ({ xMin, xMax, yMin, yMax, height, width }),
    [xMin, xMax, yMin, yMax, height, width]
  );
  return (0, import_jsx_runtime12.jsx)(CoordinateContext_default.Provider, { value: coordinateContext, children: (0, import_jsx_runtime12.jsx)(SpanContext.Provider, { value: { xSpan, ySpan }, children: (0, import_jsx_runtime12.jsx)(
    TransformContext.Provider,
    {
      value: { userTransform: vec.identity, viewTransform },
      children: (0, import_jsx_runtime12.jsx)(PaneContext_default, { children: (0, import_jsx_runtime12.jsxs)(
        "svg",
        {
          width,
          height,
          ...
          children: [
            children,
            debug && (0, import_jsx_runtime12.jsx)(
              "rect",
              {
                x: viewBoxX,
                y: viewBoxY,
            ...
            debug && (0, import_jsx_runtime12.jsx)(Debug.ViewportInfo, {})
          ]
        }
      ) })
    }
...
var defaultLabelMaker = (x) => (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
  x,
  x < 0 && (0, import_jsx_runtime13.jsx)("tspan", { visibility: "hidden", children: "-" })
] });
...
function XLabels({ separation, labelMaker }) {
  ...
  return (0, import_jsx_runtime13.jsx)("g", { className: "mafs-axis", children: xPanes.map(([min, max]) => (0, import_jsx_runtime13.jsx)("g", { children: snappedRange(min, max, separation).filter((x) => Math.abs(x) > separation / 1e6).map((x) => (0, import_jsx_runtime13.jsx)(
    "text",
    {
...
function YLabels({ separation, labelMaker }) {
  ...
  return (0, import_jsx_runtime13.jsx)("g", { className: "mafs-axis", children: yPanes.map(([min, max]) => (0, import_jsx_runtime13.jsx)("g", { children: snappedRange(min, max, separation).filter((y) => Math.abs(y) > separation / 1e6).map((y) => (0, import_jsx_runtime13.jsx)(
    "text",
    {
      x: 5,
...
function Cartesian({
  ...
  const id = React13.useMemo(() => `cartesian-${incrementer++}`, []);
  const { viewTransform } = useTransformContext();
  ...
  return (0, import_jsx_runtime14.jsxs)("g", { fill: "none", children: [
    (0, import_jsx_runtime14.jsxs)("pattern", { x: 0, y: 0, width: unitW, height: unitH, id, patternUnits: "userSpaceOnUse", children: [
      (0, import_jsx_runtime14.jsx)(
        "pattern",
        {
          ...
          children: (0, import_jsx_runtime14.jsxs)("g", { stroke: "var(--grid-line-subdivision-color)", children: [
            xAxisEnabled !== false && xSubs > 1 && (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [
              (0, import_jsx_runtime14.jsx)("line", { x1: 0, y1: 0, x2: 0, y2: subUnitH }),
              (0, import_jsx_runtime14.jsx)("line", { x1: subUnitW, y1: 0, x2: subUnitW, y2: subUnitH })
            ] }),
            yAxisEnabled !== false && ySubs > 1 && (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [
              (0, import_jsx_runtime14.jsx)("line", { x1: 0, y1: 0, x2: subUnitW, y2: 0 }),
              (0, import_jsx_runtime14.jsx)("line", { x1: 0, y1: subUnitH, x2: subUnitW, y2: subUnitH })
            ] })
          ] })
        }
      ),
      (0, import_jsx_runtime14.jsx)("rect", { width: unitW, height: unitH, fill: `url(#${id}-subdivision)` }),
      (0, import_jsx_runtime14.jsxs)("g", { stroke: "var(--mafs-line-color)", children: [
        yAxisEnabled && xAxis.lines && (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [
          (0, import_jsx_runtime14.jsx)("line", { x1: 0, y1: 0, x2: unitW, y2: 0 }),
          (0, import_jsx_runtime14.jsx)("line", { x1: 0, y1: unitH, x2: unitW, y2: unitH })
        ] }),
        xAxisEnabled && yAxis.lines && (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [
          (0, import_jsx_runtime14.jsx)("line", { x1: 0, y1: 0, x2: 0, y2: unitH }),
          (0, import_jsx_runtime14.jsx)("line", { x1: unitW, y1: 0, x2: unitW, y2: unitH })
        ] })
      ] })
    ] }),
    (0, import_jsx_runtime14.jsx)("rect", { x: vxMin, y: vyMax, width: vxMax - vxMin, height: vyMin - vyMax, fill: `url(#${id})` }),
    (0, import_jsx_runtime14.jsxs)("g", { stroke: "var(--mafs-origin-color)", strokeWidth: "var(--mafs-axis-stroke-width)", children: [
      xAxisEnabled && xAxis.axis && (0, import_jsx_runtime14.jsx)("line", { x1: vxMin, y1: 0, x2: vxMax, y2: 0 }),
      yAxisEnabled && yAxis.axis && (0, import_jsx_runtime14.jsx)("line", { x1: 0, y1: vyMin, x2: 0, y2: vyMax })
    ] }),
    (0, import_jsx_runtime14.jsxs)("g", { className: "mafs-shadow", children: [
      xAxisEnabled && xAxis.labels && (0, import_jsx_runtime14.jsx)(XLabels, { separation: xAxis.lines || 1, labelMaker: xAxis.labels }),
      yAxisEnabled && yAxis.labels && (0, import_jsx_runtime14.jsx)(YLabels, { separation: yAxis.lines || 1, labelMaker: yAxis.labels })
    ] })
  ] });
}
...
function PolarCoordinates({
  ...
  return (0, import_jsx_runtime15.jsxs)("g", { fill: "none", children: [
    (0, import_jsx_runtime15.jsx)("g", { stroke: "var(--grid-line-subdivision-color)", children: thetas.map((theta) => (0, import_jsx_runtime15.jsx)(
      "line",
      {
        x1: 0,
        y1: 0,
    ...
    subRs.map((r) => (0, import_jsx_runtime15.jsx)(
      "ellipse",
      {
        "data-r": r,
        cx: 0,
    ...
    rs.map((r) => (0, import_jsx_runtime15.jsx)(
      "ellipse",
      {
        "data-r": r,
        cx: 0,
    ...
    (0, import_jsx_runtime15.jsxs)("g", { stroke: "var(--mafs-origin-color)", strokeWidth: "var(--mafs-axis-stroke-width)", children: [
      xAxisEnabled && xAxis.axis && (0, import_jsx_runtime15.jsx)("line", { x1: vxMin, y1: 0, x2: vxMax, y2: 0 }),
      yAxisEnabled && yAxis.axis && (0, import_jsx_runtime15.jsx)("line", { x1: 0, y1: vyMin, x2: 0, y2: vyMax })
    ] }),
    (0, import_jsx_runtime15.jsxs)("g", { className: "mafs-shadow", children: [
      xAxisEnabled && xAxis.labels && (0, import_jsx_runtime15.jsx)(
        XLabels,
        {
      ...
      yAxisEnabled && yAxis.labels && (0, import_jsx_runtime15.jsx)(
        YLabels,
        {
  ...
  return (0, import_jsx_runtime16.jsx)(
    "path",
    {
      ...
      style: {
        ...
        strokeDasharray: style === "dashed" ? "var(--mafs-line-stroke-dash-style)" : void 0,
        vectorEffect: "non-scaling-stroke",
        transform: "var(--mafs-view-transform)",
        ...svgPathProps.style || {}
      }
...
function OfX({ y, domain, ...props }) {
  ...
  const xy = React15.useCallback((x) => [x, y(x)], [y]);
  const parametricDomain = React15.useMemo(() => [xMin, xMax], [xMin, xMax]);
  return (0, import_jsx_runtime17.jsx)(Parametric, { xy, domain: parametricDomain, ...props });
}
OfX.displayName = "Plot.OfX";
function OfY({ x, domain, ...props }) {
  ...
  const xy = React16.useCallback((y) => [x(y), y], [x]);
  const parametricDomain = React16.useMemo(() => [yMin, yMax], [yMin, yMax]);
  return (0, import_jsx_runtime18.jsx)(Parametric, { xy, domain: parametricDomain, ...props });
}
...
function VectorField({
  ...
  return (0, import_jsx_runtime19.jsx)(import_jsx_runtime19.Fragment, { children: layers.map((layer, index) => (0, import_jsx_runtime19.jsx)(
    "path",
    {
      d: layer.d,
      style: {
...
function Inequality({
  ...
  return (0, import_jsx_runtime20.jsxs)("g", { children: [
    ...
    upperBoundType != 0 && (0, import_jsx_runtime20.jsx)(
      "path",
      {
        d: svgPath.upper,
    ...
    lowerBoundType != 0 && (0, import_jsx_runtime20.jsx)(
      "path",
      {
        d: svgPath.lower,
...
function PointAngle({ point, angle, ...rest }) {
  ...
  return (0, import_jsx_runtime22.jsx)(ThroughPoints, { point1: point, point2, ...rest });
}
PointAngle.displayName = "Line.PointAngle";
function PointSlope({ point, slope, ...rest }) {
  return (0, import_jsx_runtime23.jsx)(PointAngle, { point, angle: Math.atan(slope), ...rest });
}
...
function Vector({
  ...
  const id = React17.useMemo(() => `mafs-triangle-${incrementer2++}`, []);
  return (0, import_jsx_runtime27.jsxs)(import_jsx_runtime27.Fragment, { children: [
    (0, import_jsx_runtime27.jsx)("defs", { children: (0, import_jsx_runtime27.jsx)("marker", { id, markerWidth: "8", markerHeight: "8", refX: "8", refY: "4", orient: "auto", children: (0, import_jsx_runtime27.jsx)("path", { d: "M 0 0 L 8 4 L 0 8 z", fill: color || "var(--mafs-fg)", strokeWidth: 0 }) }) }),
...
function useStopwatch(options) {
  ...
  const startClockTime = React18.useRef(null);
  const [time, setTime] = React18.useState(startTime);
  const [playing, setPlaying] = React18.useState(false);
  React18.useEffect(() => {
    let request = -1;
    function tick(now) {
      now = now / 1e3;
  ...
  const start = React18.useCallback(() => setPlaying(true), []);
  const stop = React18.useCallback(() => {
    startClockTime.current = null;
    setPlaying(false);
    setTime(startTime);
  }, [startTime]);
    ...
    "foreignObject",
    {
      ...
      children: (0, import_jsx_runtime30.jsx)(
        "div",
        {
          ...
          children: (0, import_jsx_runtime30.jsx)("span", { ref })
        }
      )
    }
  );
